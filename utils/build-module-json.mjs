...
template.url = "https://github.com/toastygm/hm-cpn-earlsprogress";
template.bugs = "https://github.com/toastygm/hm-cpn-earlsprogress/issues";
template.manifest =
    "https://github.com/toastygm/hm-cpn-earlsprogress/releases/latest/download/module.json";
template.download = `https://github.com/toastygm/hm-cpn-earlsprogress/releases/download/v${pkg.version}/module.zip`;
